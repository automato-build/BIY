...
sudo pip3.6 install --user pyyaml numpy cython SpeechRecognition setuptools wheel pyaudio google-api-python-client gcloud oauth2client
sudo pip3.6 install SpeechRecognition
sudo pip3.6 install --upgrade pocketsphinx
sleep 1
clear
sleep 1
...
sudo cp /usr/local/lib/python3.6/site-packages/speech_recognition/__init__.py /usr/local/lib/python3.6/site-packages/speech_recognition/__init__.py.backup
cd /modified && sudo cp __init__.py /usr/local/lib/python3.6/site-packages/speech_recognition/__init__.py
cd ..
