...
# -------------------------------------------
google_cred_file = 'google_creds.json' # for my mac
...
# -------------------------------------
wit_ai_cred_file = 'wit_ai_creds.json'
...
# -------------------------------------
azzure_cred_file = 'azzure_creds.json'
...
# -------------------------------------
houndify_cred_file = 'houndify_creds.json'
